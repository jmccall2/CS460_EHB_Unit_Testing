...
public class GoodHoldingButton {
  ...
  private boolean _shortHold = true;
  ...
  {
    _speed = 0;
//    System.out.println(ButtonInterface.isPressed());
    if (ButtonInterface.isPressed())
    {
...
//                _engaged = !_engaged;
    ...
    if(ButtonInterface.isDown() && _shortHold)
    {


//      System.out.println("In the engaged state");
...
//                System.out.println("closestResult = " + closestResult);
    ...
    else if(ButtonInterface.isDown() && !_shortHold)
    {
