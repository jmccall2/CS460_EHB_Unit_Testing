...
//    hold without holding the button
    // hand brake button is down
    public static final String IS_DOWN = "Is down";

    // hand brake button is up
    public static final String IS_UP = "Is up";

//    change to revert
    public static final String IS_PRESSED = "Is Pressed";
}
