...
import simulator.simulation.engine.UILabel;
import simulator.simulation.engine.UITextField;
...
public class GUI
{
    ...
    /*
     * Update the allowed gear transitions for the current speed.
     * @param speed
     */
    public void setGearTransitions(double speed)
    {
      _controller._setGearTransitions();
    }
    ...
    private void _addGUIFXMLCode()
    {
      ...
      try
      {
        FXMLLoader loader = new FXMLLoader(GUI.class.getResource("/simulator/resources/fxml/controlPanel.fxml"));
    ...
    private void _addErrorPopupFXMLCode()
    {
      ...
      try
      {
        FXMLLoader loader = new FXMLLoader(GUI.class.getResource("/simulator/resources/fxml/errorPopup.fxml"));
