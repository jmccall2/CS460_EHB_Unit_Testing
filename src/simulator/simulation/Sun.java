...
public class Sun extends RenderEntity
{
    ...
    {
        for(int i = 1; i <= 4; i++) _animationSequence.addAnimationFrame("sun", "simulator/resources/img/world/sun" + i + ".png");
        for(int i = 4; i >= 1; i--) _animationSequence.addAnimationFrame("sun", "simulator/resources/img/world/sun" + i + ".png");
