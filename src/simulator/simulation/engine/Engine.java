package simulator.simulation.engine;

import javafx.application.Platform;
import simulator.simulation.ApplicationEntryPoint;
...
public class Engine extends Application implements PulseEntity, MessageHandler {
    ...
    public void start(Stage stage) {
        ...
        // Listen for requests to shutdown the simulator
...
//    }
    ...
    {
        _cvarSystem.loadConfigFile("src/simulator/resources/engine.cfg");
