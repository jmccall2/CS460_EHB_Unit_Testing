...
public class TireTrack extends RenderEntity
{
    ...
    {
        if(tractionLossLevel==1) setTexture("simulator/resources/img/car/tiretrack.png");
        if(tractionLossLevel==2)
        {
            if(_swerveToggle%2==0) setTexture("simulator/resources/img/car/swerveLeft.png");
            else setTexture("simulator/resources/img/car/swerveRight.png");
            _swerveToggle++;
        }
