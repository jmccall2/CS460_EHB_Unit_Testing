...
public class Car extends RenderEntity
{
    ...
    private boolean _simulationOn = false;
    ...
    {
        for(int i = 1; i <= 13; i++) _animationSequence.addAnimationFrame("car_drive", "simulator/resources/img/car/car" + i + ".png");
        for(int i = 13; i >= 1; i--) _animationSequence.addAnimationFrame("car_reverse", "simulator/resources/img/car/car" + i + ".png");
    }
    ...
    private void update(double deltaSeconds){
        ...
        guiRef.setGearTransitions(speedToDisplay);
