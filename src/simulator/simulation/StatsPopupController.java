...
public class StatsPopupController
{
    ...
    private ImageView _left = new ImageView(
            new Image(getClass().getResourceAsStream("/simulator/resources/img/left.png")));
    private ImageView _right = new ImageView(
            new Image(getClass().getResourceAsStream("/simulator/resources/img/right.png")));
    ...
    void init(StatCollector stats) {
        ...
        _lineChart.getStylesheets().add(
                getClass().getResource("/simulator/resources/css/graphCSS.css").toExternalForm());
        _lineChart.applyCss();
